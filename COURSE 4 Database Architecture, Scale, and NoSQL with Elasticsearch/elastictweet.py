...
doc = {
    'author': 'ohnitsuj',
    'type' : 'tweet',
    'text': 'different computers by using a different interpreter on the new machine or recompiling the code to create a machine language version of the program for the new machine These programming language translators fall into two general categories An interpreter reads the source code of the program as',
    'timestamp': datetime.now(),
}

# Note - you can't change the key type after you start indexing documents
res = es.index(index=indexname, id='abc', body=doc, doc_type='None')
print('Added document...')
print(res['result'])

res = es.get(index=indexname, id='abc', doc_type='None')
...
res = es.search(index=indexname, body=x, doc_type='None')
