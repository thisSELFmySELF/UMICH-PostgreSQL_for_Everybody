...
-- The whole point of using indexing i.e to_tsvector and to_tsquery is so that the end user can avoid doing any sequential scans that will take a longer time to retrive the sql queries.
